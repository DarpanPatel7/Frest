        ...
        public async Task<JsonResult> GetCaptchaDetails(string strLast, string strName = "CaptchaCode")
        {
            ...
            try
            {
                ...
                using (var image = new Image<Rgba32>(width, height))
                {
                    ...
                    image.Mutate(ctx => ctx.Fill(Color.ParseHex("#bb8120")));
                    ...
                    image.Mutate(ctx => ctx.DrawText(captcha.ToString(), font, Color.ParseHex("#351106"), new PointF(10, 10)));
